...
import { ToolConsumer } from "./rl-server-lib/database/entities/ToolConsumer";
...
const ENV_VARS = {
      ...
      },
    {
      ...
      iss: "https://canvas.instructure.com",
      platformOIDCAuthEndPoint: "https://729fa750dce5.ngrok.io/api/lti/authorize_redirect",
      platformAccessTokenEndpoint: "https://729fa750dce5.ngrok.io/login/oauth2/token",
      alg: "RS256",
      keyid: "ASU ETX - Ring Leader - james-stanley  - Public Key",
      public_key: "-----BEGIN PUBLIC KEY-----\\nZwIDAQAB\n-----END PUBLIC KEY-----\n",
      public_key_jwk: {
      ...
      {
        name: "blackboard",
        client_id: "f6dfa56c-8620-475f-b3df-4697e542404b",
        iss: "https://blackboard.com",
        platformOIDCAuthEndPoint: "https://partner-smoke-test-b.blackboard.com/learn/api/public/v1/oauth2/authorizationcode",
        platformAccessTokenEndpoint: "https://partner-smoke-test-b.blackboard.com/learn/api/public/v1/oauth2/token",
        alg: "RS256",
        keyid: "ASU ETX - Ring Leader - james-stanley  - Public Key",
        public_key: "-----BEGIN PUBLIC KEY-----\\nZwIDAQAB\n-----END PUBLIC KEY-----\n",
        public_key_jwk: {
      ...
      {
        name: "ring-leader-demo-lambda",
        client_id: "97140000000000191",
        deployment_id: "428:5440a08422ab1ee7794a0588b5e4cb4a094c4256",
        iss: "https://canvas.instructure.com",
        platformOIDCAuthEndPoint: "https://unicon.instructure.com/api/lti/authorize_redirect",
        platformAccessTokenEndpoint: "https://unicon.instructure.com/login/oauth2/token",
        alg: "RS256",
